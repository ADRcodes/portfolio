  ...
  return (
    <BionicTextProvider>
      <div className="p-4 m-4 bg-green-100 rounded-3xl">
        ...
        <div
          className={`p-8 font-custom2 rounded-3xl bg-white ${isTextVisible ? "fade-in" : "fade-out"
            }`}>
